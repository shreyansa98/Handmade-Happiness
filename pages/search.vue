                  ...
                  <div>
                    <div class="row">
                       ...
                       <div class="col-sm-9">
                         <div class="a-row a-spacing-small">
                           ...
                           <nuxt-link :to="`/products/${product.objectID}`" class="a-link-normal">
                             <h2 class="a-size-medium">
                               ...
                               <span class="a-letter-space"></span>
                               <span class="a-size-small a-color-secondary">May 29, 2020</span>
                             </h2>
                           </nuxt-link>
                         </div>
                         ...
                         <!-- Shipment -->
                         <div class="a-row">
                           <span class="a-small-size">Ships to Pune</span>
                         </div>
                         ...
                         <div class="row">
                           <div class="col-sm-7">
                             ...
                             <div class="a-row a-spacing-none">
                               ...
                               <span class="a-letter-space"></span>
                               <span class="a-size-base-plus a-color-secondary a-text-strike">Rs 1429</span>
                             </div>
